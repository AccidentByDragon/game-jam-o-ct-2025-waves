...
# Scripts & Code
  ## Game
    ...
    I am paritcularly pleased with the wave spawnign functions as the guide i was orignally followed was a very simplistic version that wnet by each spawn point node by node with variables for each node and wave that was spawned at the node inside the For loop,
